namespace EPR.Accreditation.Portal.ViewModels
{
    ...
    /// </summary>
    public class WasteLicencesAndPermitsViewModel
    {
        /// <summary>
        ...
        /// </summary>
        [RegularExpression(@"^[a-zA-Z0-9/]*$", ErrorMessageResourceType = typeof(WasteLicencesAndPermitsResources), ErrorMessageResourceName = "ErrorMessageInvalidFormat")]
        [StringLength(20, ErrorMessageResourceType = typeof(WasteLicencesAndPermitsResources), ErrorMessageResourceName = "ErrorMessageTooLong")]
