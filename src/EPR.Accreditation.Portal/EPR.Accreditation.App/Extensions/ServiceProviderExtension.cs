...
using EPR.Accreditation.App.Helpers.AuthHelpers;
using EPR.Accreditation.App.Middleware.Auth;
using EPR.Accreditation.App.Options;
using EPR.Accreditation.App.Services.AuthServices;
using EPR.Accreditation.App.Services.AuthServices.Interfaces;
using EPR.Accreditation.App.Sessions;
...
using CookieOptions = EPR.Accreditation.App.Options.CookieOptions;
using SessionOptions = EPR.Accreditation.App.Options.SessionOptions;
